		...
		<div class="container">
			...
			<div class="navbar-collapse collapse"
				...
				<ul class="nav navbar-nav">
					...
					<c:if test="${user==null}">
						<li class="dropdown"><a href="Login.jsp"><i
								class="fa fa-user"></i><span>Login</span></a></li>
						<li class="dropdown"><a href="register.jsp"><i
								class="fa fa-user"></i><span>Register</span></a></li>
					</c:if>
				...
				<c:if test="${user.role == 2}">
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav nav_1">
							...
							<li><a href="InstructorStart.jsp">Current Semester</a></li>
